      ...
      <div className="p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full rounded-md bg-blue-600 hover:bg-blue-700 text-white py-2 text-sm font-medium transition flex items-center justify-center gap-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
    ...
    {workspace?.owner?.id !== currentUserId && (
      ...
      {currentUserId && (
        <ManageMembersModal
          ...
          isOwner={workspace?.owner?.id === currentUserId}
        />
      )}
    </div>
  );
