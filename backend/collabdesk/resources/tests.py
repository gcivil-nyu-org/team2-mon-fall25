...
class ResourceAPITests(APITestCase):
    ...
    def test_download_local_filesystem(self):
        ...
        download_url = reverse("resources:resource-download", args=[r.profile_id])
        ...
        self.assertIn(
            'attachment; filename="local_test.txt"', resp.get("Content-Disposition")
        )
    ...
    def test_preview_local_filesystem(self):
        ...
        preview_url = reverse("resources:resource-preview", args=[r.profile_id])
    ...
    def test_upload_file_db_failure(self):
        ...
        with patch("resources.views.upload_file_to_s3") as mock_upload:
            ...
            with patch("resources.models.Resource.save") as mock_save:
                ...
                resp = self.client.post(
                    url, {"file": uploaded_file}, format="multipart"
                )
    ...
    def test_upload_file_s3_failure(self):
        ...
        with patch("resources.views.upload_file_to_s3") as mock_upload:
            ...
            resp = self.client.post(url, {"file": uploaded_file}, format="multipart")
            self.assertEqual(resp.status_code, 500)
    ...
    def test_update_tags_single_string(self):
        ...
        resp = self.client.patch(
            detail_url, data={"tags": '"updatedtag"'}, format="multipart"
        )
        self.assertEqual(resp.status_code, 200)
    ...
    def test_update_resource_with_new_file(self):
        ...
        resp = self.client.patch(
            detail_url, data={"file": new_file}, format="multipart"
        )
        self.assertEqual(resp.status_code, 200)
        data = resp.json()
